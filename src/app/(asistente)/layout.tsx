...
const NAV = [
  { href: "/asistente/dashboard", label: "Inicio"        },
  { href: "/asistente/agenda",    label: "Agenda de hoy" },
  { href: "/asistente/citas",     label: "Citas"         },
  { href: "/asistente/pacientes", label: "Pacientes"     },
  { href: "/asistente/agua-energetica", label: "Agua Energetica" },
];

export default async function AsistenteLayout({ children }: { children: React.ReactNode }) {
    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <aside className="hidden md:flex w-56 flex-col bg-white border-r border-gray-200 py-6 px-4 shrink-0">
        <div className="mb-6 px-2">
          ...
          <span className="text-[10px] bg-purple-100 text-purple-700 px-1.5 py-0.5 rounded mt-1 inline-block font-medium">
            Asistente
          </span>
        </div>
