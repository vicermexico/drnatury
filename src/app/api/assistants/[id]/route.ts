...
export async function PATCH(
  ...
  // ── Cambio de teléfono (requiere actualizar auth.users también) ──
  if (body.phone !== undefined) {
    ...
    // Verificar que el número no esté en uso por otro perfil activo
    ...
    // Actualizar email en auth.users (el teléfono es el identificador de acceso)
