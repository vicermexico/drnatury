...
const validTipos = ["video_fondo", "video_resultado"];

// Mismo patron que /api/agua-energetica/upload: el navegador pide aqui un
// "permiso de subida" (sin mandar el archivo), y luego sube el archivo
// DIRECTO a Supabase Storage, sin pasar por Vercel (los videos son mas
// grandes que el limite de 4.5MB del cuerpo de una funcion de Vercel).
