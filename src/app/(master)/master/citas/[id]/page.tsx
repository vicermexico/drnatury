    ...
    <div className="max-w-lg space-y-6">
      <div>
        <div className="flex items-center gap-2 text-sm mb-3">
          <Link href="/master/citas" className="text-gray-400 hover:text-gray-600">Citas</Link>
      ...
      {patient && (
        <section className="rounded-2xl bg-white border border-gray-200 p-5 space-y-3">
          <div className="flex items-center justify-between">
            ...
            <Link href={`/master/pacientes/${patient.id}`} className="text-xs text-blue-600 hover:underline">
              Ver perfil
            </Link>
          </div>
