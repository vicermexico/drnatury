        ...
        <div className="space-y-3">
          {services.map((s) => {
            ...
            return (
              <Link
                key={s.id}
                href={`/master/servicios/${s.id}`}
                className="block rounded-2xl bg-white border border-gray-200 px-5 py-4 space-y-3 hover:border-blue-300 hover:shadow-sm transition"
              >
